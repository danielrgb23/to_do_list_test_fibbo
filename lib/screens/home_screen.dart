...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    auth != null
        ? context.read<TaskProvider>().backupTasks(auth!.uid)
        : log('Não esta logado');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        ? Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) =>  ProfileScreen(user: auth!,)),
                )
        : Navigator.push(
                  context,
    ...
    if (isGroupedByPriority) {
      ...
      return ListView(
        children: [
          ...
          if (groupedTasks['Média']!.isNotEmpty) ...[
            _buildPrioritySection('Média', groupedTasks['Média']!),
          ],
